...
|}>;
export default class FormLogin extends React.Component<Props, $FlowFixMeState> {
  _password: null | React.ElementRef<typeof RNTextInput>;
  ...
  _submit() {
    this.setState(
      (prevState) => {
        ...
        return {errorMessages, loading: true};
      },
      () => {
        if (
  ...
  _onChangeField(field: string, text: string) {
